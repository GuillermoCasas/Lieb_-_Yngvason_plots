...
# Calculate midpoint between curves at V0 - 0.04
x_eps = V0 - 0.04
...
ax2.plot(t, h, color=C_FILL, lw=2.4, label=r"$h(t)=\mathcal{W}_\varepsilon-\mathcal{W}{0}$")
...
fig.savefig("scratch/test_lemma51_eps.png", dpi=150, bbox_inches="tight")
print("Saved test figure eps.")
