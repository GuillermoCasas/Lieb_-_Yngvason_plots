...
ax1.text(V_lbl, W0_lbl - 0.05, r"$S = S_0$", color=C_LOW, fontsize=12, va="top", ha="center", weight="bold")
ax1.text(V_lbl, We_lbl + 0.05, r"$S = S_\varepsilon$", color=C_HIGH, fontsize=12, va="bottom", ha="center", weight="bold")
...
# Vertical dashed lines from V0 and V_END on the x-axis to the curves
ax1.plot([V0, V0], [1.1, We_V0], color='gray', ls=':', lw=1.0)
ax1.plot([V_END, V_END], [1.1, We_Ve], color='gray', ls=':', lw=1.0)
...
fig.savefig("scratch/test_lemma51_s.png", dpi=150, bbox_inches="tight")
print("Saved test figure S.")
